        ...
        <div className='flex items-center gap-4'>
            ...
            <div className='group relative'>
                ...
                <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                    <div className='flex flex-col gap-2 w-36 py-4 px-4 bg-slate-100 text-gray-700'>
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute -right-1.25 -bottom-1.25 w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[7px]'>1</p>
            </Link>
